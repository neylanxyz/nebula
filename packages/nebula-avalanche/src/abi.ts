export const VERIFIER_ABI = [
  ...
  { inputs: [], name: 'PROOF_TOO_SHORT', type: 'error' },
  { inputs: [], name: 'POINT_NOT_ON_CURVE', type: 'error' },
  { inputs: [], name: 'INVALID_PROOF_POINT', type: 'error' },
  { inputs: [], name: 'MOD_EXP_FAILURE', type: 'error' },
  { inputs: [], name: 'EC_SCALAR_MUL_FAILURE', type: 'error' },
  { inputs: [], name: 'PROOF_FAILURE', type: 'error' },
  { inputs: [], name: 'PUBLIC_INPUT_TOO_LARGE', type: 'error' },
] as const;
...
export const NEBULA_POOL_ABI = [
  ...
  { inputs: [], name: 'UnknownRoot', type: 'error' },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'blacklistedAddress', type: 'address' },
    ],
    name: 'Blacklisted',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'burnAddress', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
    name: 'FeesBurned',
    type: 'event',
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'pardonedAddress', type: 'address' },
    ],
    name: 'Pardoned',
    type: 'event',
  },
  ...
  },
  {
    inputs: [],
    name: 'poseidon',
    outputs: [{ internalType: 'contract IPoseidonT2', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
